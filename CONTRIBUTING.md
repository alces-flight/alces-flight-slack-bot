# Contributing to Flight Slack Bot

:+1::tada: Thanks for taking the time to contribute! :tada::+1:

You want to contribute to Flight Slack Bot? Welcome! Please read this
...
You can help Flight Slack Bot by helping others who use it and need support.

## Analyse Issues

Analysing issue reports can be a lot of effort. Any help is welcome!
Go to [the GitHub issue tracker](https://github.com/alces-flight/flight-slack-bot/issues?state=open)
...
If you find a bug - behaviour of Flight Slack Bot code or documentation
...
[GitHub issue tracker for Flight Slack Bot](https://github.com/alces-flight/flight-slack-bot/issues/new)
to report the issue.
...
We want to improve the quality of Flight Slack Bot and good bug reports are
...
Flight Slack Bot is Open Source and comes without warranty.
...
Flight Slack Bot in order to fix bugs or to implement new features.
...
2. **Not all proposed contributions can be accepted**. Some features
   ...
   the overall direction of Flight Slack Bot and really improve it. The more
...
applied to Flight Slack Bot itself.

In particular you need to agree to the Contributor License Agreement,
which can be [found
here](https://www.clahub.com/agreements/alces-flight/flight-slack-bot). This
...
8. Wait for our code review and approval, possibly enhancing your
   change on request.
    - Note that the Flight Slack Bot developers also have their regular
